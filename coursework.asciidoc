...
Before attempting this coursework, please complete link:https://github.com/DnsZhou/CSC8109-Group-Project-in-Cloud-Computing/blob/master/tutorial.asciidoc[this tutorial].
...
* *Red Hat OpenShift on AWS*. This is the Platform as a Service (PaaS) that you will use to deploy your application to the AWS Cloud.
...
Also frequently asked questions will be posted by demonstrators link:https://github.com/NewcastleComputingScience/enterprise-middleware-coursework/blob/master/frequentlyaskedquestions.asciidoc[here].
